...
# Compute risk scores.
#
# Compute risk scores on clinical trial data, using pre-validation. 
# To compute the predilection score, we use linear regression (continuous response) or logistic regression (binary response).
...
# param family The response type: "binomial" or "gaussian".
